  ...
  /******/([
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      NotifierPrototype.uncaughtError = _wrapNotifierFn(function (message, url, lineNo, colNo, err, context) {
        ...
        this._enqueuePayload(payload, true, [
      ...
      function _processPayload(payloadObject) {
        ...
        var checkOverRateLimit = function () {
          return !payload.ignoreRateLimit && globalRateLimit >= 1 && rateLimitCounter >= globalRateLimit;
        };
        var checkOverRateLimitPerMin = function () {
          return !payload.ignoreRateLimit && globalRateLimitPerMin >= 1 && rateLimitPerMinCounter >= globalRateLimitPerMin;
        };
